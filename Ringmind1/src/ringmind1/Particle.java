...
public class Particle extends PApplet
{
	...
	int col;
	static float defaultMass = 0.3f*PI;//initial mass of a particle
	...
	Particle(float x, float y, float m_, float rp, float rD, float iD, Box2DProcessing box) 
	{
		this.box2d = box;
		m = m_;
		rockPercent = rp;
	...
	Particle(float x, float y, float rD, float iD, Box2DProcessing box)
	{
		//this(x,y,0.62832f);
		this(x,y,defaultMass, (float)Math.random(), rD, iD, box);
	}
